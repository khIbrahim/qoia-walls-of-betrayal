...
class StaffChatCommand extends WCommand
{
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        ...
        $newState = isset($args[self::STATE_ARGUMENT]) ? (bool) $args[self::STATE_ARGUMENT] : ! $session->isStaffChatEnabled();
        $session->setStaffChat($newState);
    }

    public function getCommandDTO(): CommandDTO
    {
        return CommandsConfig::getCommandById(CommandsIds::STAFF_CHAT);
    }
}