...
use fenomeno\WallsOfBetrayal\libs\poggit\libasynql\base\DataConnectorImpl;
use fenomeno\WallsOfBetrayal\libs\poggit\libasynql\base\SqlThreadPool;
use fenomeno\WallsOfBetrayal\libs\poggit\libasynql\mysqli\MysqlCredentials;
use fenomeno\WallsOfBetrayal\libs\poggit\libasynql\mysqli\MysqliThread;
use fenomeno\WallsOfBetrayal\libs\poggit\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function detectPackaged() : void{
		self::$packaged = __CLASS__ !== 'fenomeno\WallsOfBetrayal\libs\poggit\libasynql\libasynql';
