...
namespace fenomeno\WallsOfBetrayal\libs\dktapps\pmforms;

use Closure as OnSubmit;
use fenomeno\WallsOfBetrayal\libs\dktapps\pmforms\element\CustomFormElement;
...
class CustomForm extends BaseForm{
	 ...
	 * @phpstan-param OnSubmit|null $onClose
	 *
