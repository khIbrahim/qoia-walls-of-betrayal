...
// Listing menu
    ...
    public const KINGDOMS_LOYALTY_BETRAYAL_MODE_ENABLED = 'kingdoms.loyalty.betrayalModeEnabled';
    public const KINGDOMS_LOYALTY_LOYAL_MODE_ENABLED = 'kingdoms.loyalty.loyalModeEnabled';
    public const KINGDOMS_LOYALTY_SUSPECT_MODE_ENABLED = 'kingdoms.loyalty.suspectModeEnabled';
    public const BETRAYAL_KILL = 'kingdoms.loyalty.betrayalKill';
    public const NO_LONGER_AFK = 'common.noLongerAfk';
    public const YOU_ARE_AFK = 'common.youAreAfk';
    ...
    public const BANDAGE_USED_ON_OTHER = 'items.bandage.used.other';
    public const BANDAGE_USED_ON_YOU   = 'items.bandage.used.self';
    public const BANDAGE_CANT_USE_ON_LOW_HEALTH_OTHER = 'items.bandage.cantUseOnLowHealth.other';
    public const BANDAGE_CANT_USE_ON_LOW_HEALTH_SELF = 'items.bandage.cantUseOnLowHealth.self';
    public const BANDAGE_COOLDOWN_ON_OTHER = 'items.bandage.cooldown.other';
    public const BANDAGE_CANT_USE_ON_UNTAGGED = 'items.bandage.cantUseOnUntaggedPlayer';
    public const BANDAGE_COOLDOWN_ON_YOU = 'items.bandage.cooldown.self';
    public const CANT_HEAL_UNTAGGED = 'items.splashHeal.cantHealUntagged';
    public const CANT_HEAL_HIGH_HEALTH = 'items.splashHeal.cantHealHighHealth';
    public const DIVINE_RESTORATION_HEALED_BY_OTHER = 'items.divineRestoration.heal.other';
    public const DIVINE_RESTORATION_HEALED = 'items.divineRestoration.heal.self';
    public const HERO_HEALED_ALLY = 'kingdoms.heals.hero.healedAlly';
    public const DIVINE_RESTORATION_COOLDOWN = 'items.divineRestoration.cooldown';
    public const TOTEM_HEAL_FILL = 'blocks.totem_heal.fill';
    public const TOTEM_HEAL_EMPTY = 'blocks.totem_heal.empty';
    public const TOTEM_HEAL_STATUS = 'blocks.totem_heal.status';
    public const TOTEM_HEAL_RECEIVED = 'blocks.totem_heal.received';
    public const TOTEM_HEAL_FULL = 'blocks.totem_heal.full';
    public const TOTEM_HEAL_FLOATING_TEXT = 'blocks.totem_heal.floatingText.active';
    public const TOTEM_MAX_LEVEL = 'blocks.totem_heal.upgrade.maxLevel';
    public const TOTEM_WRONG_KINGDOM = 'blocks.totem_heal.errors.wrongKingdom';
    public const TOTEM_UPGRADED = 'blocks.totem_heal.upgrade.success';
    public const TOTEM_DESTROYED_EXPIRED = 'blocks.totem_heal.expired.destroyed';
    public const TOTEM_HEAL_EXPIRED = 'blocks.totem_heal.floatingText.expired';
}
